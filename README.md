...
## If entities aren't triggering areas

CryEngine by default disables area triggering for certain entities, but there's an easy way to make it work on any entity you want

1. Add the **Trigger Areas** component to your entity
2. Make sure the **Trigger Areas** value is set to true
